...
def process_file(raw_path: Path):
    clean_path = raw_path.with_name(raw_path.name.replace(".raw.md", ".clean.v4_2.md"))
    meta_path = raw_path.with_name(raw_path.name.replace(".raw.md", ".clean.v4_2.meta.json"))
